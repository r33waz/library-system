import { ImagePreview, uploadImage } from "@/components/common/imageUpload";
...
function libEmpProfileComp({ id }: { id: string }) {
  useMentTags("Library Employee Profile - Library Management System");
...
export default libEmpProfileComp;
